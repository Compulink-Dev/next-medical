    ...
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div className="st-footer-widget">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#" className="text-gray-600 hover:text-gray-900">
                  <i className="fas fa-chevron-right"></i>Weekly timetable
                </a>
              </li>
              <li>
                <a href="#" className="text-gray-600 hover:text-gray-900">
          ...
          <div className="st-footer-widget">
            ...
            <ul className="space-y-2">
              <li>
                <a href="#" className="text-gray-600 hover:text-gray-900">
                  <i className="fas fa-chevron-right"></i>Rehabilitation
                </a>
              </li>
              <li>
                <a href="#" className="text-gray-600 hover:text-gray-900">
                  <i className="fas fa-chevron-right"></i>Laboratory Analysis
                </a>
              </li>
              <li>
                <a href="#" className="text-gray-600 hover:text-gray-900">
                  <i className="fas fa-chevron-right"></i>Face Lift Surgery
                </a>
              </li>
              <li>
                <a href="#" className="text-gray-600 hover:text-gray-900">
                  <i className="fas fa-chevron-right"></i>Liposuction
                </a>
              </li>
            </ul>
          </div>
          <div className="st-footer-widget">
            ...
            <ul className="space-y-2">
              <li>
                <span className="text-gray-600">Address:</span> Harare
              </li>
              <li>
              ...
              <li>
                <span className="text-gray-600">Phone:</span> (+263) - 778 191
                278{" "}
              </li>
            </ul>
          </div>
      ...
      <div className="text-dark-400 py-4 mt-4">
        <div className="max-w-7xl mx-auto px-4 flex justify-between">
          <div className="">Copyright 2025. Techtrain Design</div>
          <div className="">
