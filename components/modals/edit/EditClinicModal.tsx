...
function EditClinicModal({ children, defaultValues, clinicId }: EditClinicModalProps) {
    ...
    const onSubmit = async (values: z.infer<typeof UserClinicValidation>) => {
        ...
        console.log('Submitting clinic data:', values); // Check form values
        console.log('Clinic ID:', clinicId); // Check clinic ID
